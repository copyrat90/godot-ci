...
RUN wget https://github.com/limbonaut/limboai/releases/download/v${LIMBOAI_VERSION}/limboai+v${LIMBOAI_VERSION}.godot-${GODOT_VERSION}.editor.${GODOT_PLATFORM}.zip \
